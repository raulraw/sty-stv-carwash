...
export default function ReviewsSection() {
  ...
  return (
    <section id="recenzii" className="relative z-10 py-28 overflow-hidden">
      {/* Background Image - foarte optimizat */}
      ...
      <div className="absolute top-0 left-0 right-0 h-24 pointer-events-none z-20"
        style={{ backdropFilter: 'blur(12px)', maskImage: 'linear-gradient(to bottom, black 0%, transparent 100%)' }} />
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 pointer-events-none z-20"
        style={{ backdropFilter: 'blur(12px)', maskImage: 'linear-gradient(to top, black 0%, transparent 100%)' }} />
