...
function NavButton({
  ...
  return (
    ...
    >
      ...
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true" className="relative z-10" style={{ transform: direction === 'next' ? 'rotate(180deg)' : undefined }}>
...
export default function GaleriePage() {
  ...
  const imageVariants = {
    enter: (dir: number) => ({ x: dir > 0 ? 60 : -60, opacity: 0, scale: 0.97, filter: 'blur(6px)' }),
    center: { x: 0, opacity: 1, scale: 1, filter: 'blur(0px)' },
    exit: (dir: number) => ({ x: dir > 0 ? -60 : 60, opacity: 0, scale: 0.97, filter: 'blur(6px)' }),
  };
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="pt-28 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Galerie Dinamică */}
          <div className="relative w-full min-h-[900px] md:min-h-[1100px]">
            <Masonry
              items={galleryItems}
              ease="power3.out"
              duration={0.7}
            ...
            >
              ...
              >
                ...
                <div className="relative z-30 flex items-center justify-between px-6 pt-5 pb-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="px-4 py-1.5 rounded-full bg-white/[0.08] border border-white/[0.14] backdrop-blur-xl">
                    ...
                    <motion.button onClick={closeLightbox} whileHover={{ scale: 1.08 }} whileTap={{ scale: 0.93 }} className="w-9 h-9 rounded-xl bg-[#e30613]/15 border border-[#e30613]/35 flex items-center justify-center">
